...
public partial class JAccount : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Page.IsPostBack == false)
        {
            ...
            drpdegree.SelectedItem.Text = JDT.Rows[0]["Degree"].ToString();
            drpskill.SelectedItem.Text = JDT.Rows[0]["Skill"].ToString();
            drpexp.SelectedItem.Text = JDT.Rows[0]["Experience"].ToString();
